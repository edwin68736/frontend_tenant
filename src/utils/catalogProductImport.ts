...
const HEADER_ALIASES: Record<string, (typeof CATALOG_IMPORT_COLUMNS)[number]> = {
  ...
  controla_stock: 'control_stock',
  controlar_stock: 'control_stock',
  control_de_stock: 'control_stock',
  maneja_stock: 'control_stock',
  gestiona_stock: 'control_stock',
  controla_inventario: 'control_stock',
